...
namespace TVDBSharp.Models.DAO {
    ...
    public interface IDataProvider {
        ...
        /// <summary>
        /// Retrieves the show with the given IMDb ID and returns the corresponding XML tree.
        /// </summary>
        /// <param name="imdbID">IMDb ID of the show you wish to lookup.</param>
        /// <returns>Returns an XML tree of the show object.</returns>
        XDocument GetShowByImdbID(string imdbID);
